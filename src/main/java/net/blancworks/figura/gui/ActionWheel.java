            ...
            if (cust != null && cust.texture != ActionWheelCustomization.TextureType.None && cust.uvOffset != null && cust.uvSize != null) {
                ...
                switch (cust.texture) {
                    ...
                    case Elytra:
                        ...
                        break;
                    case Resource: textureId = MinecraftClient.getInstance().getResourceManager().containsResource(cust.texturePath) ? cust.texturePath : MissingSprite.getMissingSpriteId(); break;
                    case Skin: textureId = data.playerListEntry.getSkinTexture(); break;
                    case Custom: textureId = data.texture != null ? data.texture.id : MissingSprite.getMissingSpriteId(); break;
                    default: textureId = FiguraTexture.DEFAULT_ID; break;
                }
